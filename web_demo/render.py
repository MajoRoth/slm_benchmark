...
def main():
    ...
    with open("/Users/amitroth/PycharmProjects/slm-benchnark/generated_audio/sentiment_alignment/new/metadata.json", 'r') as f:
    ...
    sections = [
        ...
        {
            "title": "Emotional Speakers Compression with varying texts",
            "description": "Compression between different speakers in the RAVDESS dataset using XTTS voice cloning model."
                           " Speakers are between 1-24 (odd are men, even are women). Emotions are from ['happy', 'sad', 'neutral'], texts generated by chat GPT",
            "table": {
                "headers": ["speaker - emotion", "audio prompt", "happy text", "sad text"],
                "content": [
                    [
                        f"{sample['speaker']} - {emotion}",
                        sample['prompts_paths'][emotion],
                        sample['generated_audio'][f'{emotion}_happy'],
                        sample['generated_audio'][f'{emotion}_sad'],

                    ] for sample in sentiment_json for emotion in emotions
                ]
            }
        }
    ]
