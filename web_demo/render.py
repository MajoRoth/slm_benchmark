...
def main():
    ...
    with open("../generated_audio/sentiment_alignment/comp/metadata.json", 'r') as f:
    ...
    sections = [
        ...
        {
            "title": f"Emotional Speakers Compression sample {sample['sample']} text ({text}) - {sample[f'{text}_text']}",
            "description": "Compression between different speakers in the RAVDESS dataset using XTTS voice cloning model."
                           " Speakers are between 1-24 (odd are men, even are women). Emotions are from ['happy', 'sad', 'neutral'], texts generated by chat GPT",
            "table": {
                "headers": ["speaker - emotion", "sad sample", "happy sample"],
                "content": [
                    [
                        f"{speaker['speaker']}",
